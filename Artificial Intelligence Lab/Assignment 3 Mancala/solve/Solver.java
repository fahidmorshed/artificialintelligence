...
public class Solver {
	...
	public static void main(String[] args) 
	{
        ...
        public static Game configGame()
        {
        /*Construct human and AI agents*/
            
        Agent human = new HumanMancalaAgent("Barry Allen");
	Agent machine = new HumanMancalaAgent("Gideon");

        System.out.println(human.name+" vs. "+machine.name);
	
        Game game = new MancalaGame(human,machine);
	//game.play();
